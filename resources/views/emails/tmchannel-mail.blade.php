                              ...
                              <tr>
                                <td class="pc-cta-box-in" style="vertical-align: top; padding: 42px 40px 35px;" valign="top">
                                  <table class="pc-cta-s1" border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                                    <tbody>
                                      <tr>
                                        <td class="pc-fb-font" style="vertical-align: top; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 25px; font-weight: 500; line-height: 1.43; color: #40BE65; text-align: center;" valign="top" align="center">TMChannel activation details</td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        <td class="pc-cta-text pc-fb-font" style="vertical-align: top; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-weight: 300; line-height: 1.56; color: #566573; text-align: left;" valign="top" align="center"> 
                                                <b>Tracking ID:</b> {{$request['tracking_id']}}<br>
                                                ...
                                                <b>Mobile:</b> {{$request['mobile']}}<br>
                                                 <a href="https://www.tmbill.net/tmchannel/">Admin Login click here</a>
