                              ...
                              <tr>
                                <td class="pc-menu-logo-s2" align="center" style="vertical-align: top; padding: 30px 40px 31px;" valign="top">
                                  <table border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 130px;" width="130">
                                    <tbody>
                                      <tr>
                                        <td style="vertical-align: top;" valign="top"> <a href="https://techmainstay.com" style="text-decoration: none;">
                                        <img src="https://techmainstay.com/images/logo.png" width="130" height="35" alt="" style="border: 0; line-height: 100%; outline: 0; -ms-interpolation-mode: bicubic; display: block; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 20px; font-weight: 500; color: #ffffff;">
                                    </a> </td>
                                      </tr>
                                    </tbody>
                                  </table>
                              ...
                              <tr>
                                <td class="pc-cta-box-in" style="vertical-align: top; padding: 42px 40px 35px;" valign="top">
                                  <table class="pc-cta-s1" border="0" cellpadding="0" cellspacing="0" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                                    <tbody>
                                      <tr>
                                        <td class="pc-fb-font" style="vertical-align: top; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 25px; font-weight: 500; line-height: 1.43; color: #40BE65; text-align: center;" valign="top" align="center">TMBill Product activation details</td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        <td class="pc-cta-text pc-fb-font" style="vertical-align: top; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-weight: 300; line-height: 1.56; color: #566573; text-align: left;" valign="top" align="center"> 
                                                ...
                                                <b>Validity:</b> {{ $request['duration'] ==1 ? '1 year': $request['duration'].' years' }} <br>
                                                <b>Product Type:</b> {{$request['type_software']}}<br>
                                                <b>Product Key:</b> {{$request['product']}}<br>
