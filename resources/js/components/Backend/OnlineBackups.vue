          ...
          <div class="col-12">
            <div class="card">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr v-for="user in VersionList.data" :key="user.id">
                          ...
                          <td>{{user.email}}</td>
                          <td>{{user.backup_time | myDate2}}</td>
                            <td>
                                <a class="btn btn-primary" @click="getDownloadUrl(user.backup_link)" title="Download sql">
              ...
              <div class="card-footer clearfix">
                  <pagination :data="VersionList" @pagination-change-page="getResults" :limit="8" :show-disabled="true">
    ...
    export default {
      data () {
        ...
        methods: {
            ...
            getResults(page = 1) {
              this.isLoad = true;
               axios.get('api/online-backup?q='+this.$parent.search+'&page=' + page)
                        .then(response => {
            ...
            getDownloadUrl(backup_link){
                ...
                this.file.post('api/online-backup-copy-file')
                .then((response) => { 
