          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                      <h3 class="card-title">CAMPAIGN ENQUIRY</h3>
                       <div class="card-tools">
                          <button type="button" class="btn btn-outline-secondary pull-right d-none d-sm-block" v-if="access_level.export==1" @click="Export">Export <i class="fas fa-cloud-download-alt"></i></button>
                          <button type="button" class="btn btn-outline-secondary pull-right d-block d-sm-none d-md-none" v-if="access_level.export==1" @click="Export"><i class="fas fa-cloud-download-alt"></i></button>
                       </div>
              </div>
              <!-- /.card-header -->
              ...
              <div class="card-footer clearfix">
                  <pagination :data="EnquiryList" @pagination-change-page="getResults" :limit="8" :show-disabled="true">
    ...
    export default {
      data () {
        ...
        methods: {
            ...
            getResults(page = 1) {
              this.isLoad = true;
               axios.get('api/campaign-enquiry?q='+this.$parent.search+'&page=' + page)
                        .then(response => {
